...
the notebook with its outputs.

If the saved notebook has a matching `.settings.json` file, keep it beside the
notebook when moving, downloading, or submitting your work.
